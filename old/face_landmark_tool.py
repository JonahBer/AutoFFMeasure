...
class FaceLandmarkApp(tk.Tk):
    ...
    def paste_image(self):
        ...
        self._load_image(img, "Clipboard")
    ...
    def _draw_marker(self, cx: int, cy: int, key: str, color: str):
        ...
        self.canvas.create_oval(cx-r, cy-r, cx+r, cy+r,
                                 fill=color, outline="#ffffff", width=1, tags="marker")
        short = _short_label(key)
        self.canvas.create_text(cx + r + 4, cy, text=short, fill=color,
                                 font=("Helvetica", 7), anchor="w", tags="marker")
    ...
    def on_canvas_click(self, event):
        ...
        # Canvas coordinates (account for scroll)
    ...
    def export_csv(self):
        ...
        self.status_var.set(f"Exported CSV → {os.path.basename(path)}")
